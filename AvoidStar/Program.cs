...
namespace Study
{
    class MyProgram
    {
        ...
        public static void Play()
        {
            ...
            bool Enemy = false; //star alive : true / star dead : false
            EnemyStar[] star = new EnemyStar[enemyCount];
            for (int i = 0; i < enemyCount; i++)
            {
                star[i] = new EnemyStar();
            }
            ...
            while (true)
            {
                ...
                for (int i = 0; i < enemyCount; i++)
                {
                    Console.SetCursorPosition(star[i].Ex, star[i].Ey);
                ...
                if (Enemy)
                {
                    for (int i = 0; i < enemyCount; i++)
                    {
                        star[i].Ey = star[i].Ey + random.Next(0, 2); // 별들의 개별 속도 조절
                    }
                }
